...
\begin{frame}[t]{Problem 5 Results}
    ...
    \begin{table}[h]
      \centering
      \resizebox{\textwidth}{!}{
        \begin{tabular}{l c c S[table-format=2.2,table-number-alignment=left] c c}\toprule
        \multirow{2}{*}{Case} & \keff{} & \multicolumn{2}{c}{{Pin Power Differences}} & 2D/1D & Runtime\\
        & Difference (pcm) & RMS & {Max} & Iterations & (Core-Hours) \\\midrule
        Reference        &  -- & --     & {--}      & 13 & 361.7 \\
        No Treatment     & -22 & 6.90\% & 30.55\% & 13   & 410.7 \\
        Polynomial       &  -5 & 1.15\% &  4.85\% & 13   & 373.7 \\
        Subplane         &  -5 & 2.09\% & 10.20\% & 13   & 399.0 \\
        Subplane + CP    &  -1 & 0.50\% &  2.74\% & 13   & 425.6 \\
        \bottomrule
    \end{tabular}
      }
    \end{table}

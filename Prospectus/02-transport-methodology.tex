This chapter is dedicated to introducing the neutron transport equation and numerical methods commonly used to solve it.  First, the transport equation will be introduced and all its terms defined.  Second, numerical methods will be discussed and, when appropriate, derived from the transport equation.  Many texts deal thoroughly with a variety of numerical methods to solve the transport equation, such as \todo{cite}.  This chapter will not attempt to reiterate all that can be found in these references, but rather to highlight the methods which are relevant to this work.  Full derivations will be done if necessary; otherwise, they will be deferred to the appendices or external references.

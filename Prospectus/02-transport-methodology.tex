...
\end{equation}
\end{subequations}
Using thee definitions above, Equation \ref{e:ssboltzmann} can be operated on by \ref{e:multigroupIntegral} to obtain the multi-group transport Equation \ref{e:multigroupboltzmann}.

...
To begin, equation \ref{e:multigroupboltzmann} \todo{use Sn equation instead} must be integrated in the $z$-direction over some range $\Delta z_i = z_{i+\frac{1}{2}} - z_{i-\frac{1}{2}}$, giving:

...
\ifdraft{\hl{Discuss what rod cusping is and why it happens.  Show some plots from MPACT.}

\section{Old Solutions}\todo{Better name}

\hl{Discuss ways people have addressed this in the past}
\hl{Discuss polynomial currently implemented in MPACT}

\section{New Solutions}\todo{Better name}}{}

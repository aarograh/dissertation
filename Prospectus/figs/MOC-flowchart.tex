...
\node (stop) [startstop, below of=MOCdone, yshift=-1.5cm] {Stop};
...
% Fancy Arrows
\draw [arrow] (MOCdone) -| node[anchor=north] {no} ([xshift=1.5cm]MOC.east) |- (scatSource);
\draw [arrow] (MOCdone) -- node[anchor=west] {yes} (stop);
